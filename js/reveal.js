...
(function (root, factory) {
  ...
  function initialize (options) {
    ...
    if (typeof query['dependencies'] !==
      'undefined') delete query['dependencies']
  ...
  function checkCapabilities () {
    ...
    features.requestAnimationFrame = typeof features.requestAnimationFrameMethod ===
      'function'
  ...
  function setupDOM () {
    ...
    // Background element
    dom.background = createSingletonNode(dom.wrapper, 'div', 'backgrounds',
      null)
    ...
    dom.speakerNotes = createSingletonNode(dom.wrapper, 'div', 'speaker-notes',
      null)
    ...
    toArray(dom.wrapper.querySelectorAll(SLIDES_SELECTOR)).
      forEach(function (slide) {
        ...
        if (slide.classList.contains('stack') === false) {
          ...
          var numberOfPages = Math.max(Math.ceil(contentHeight / pageHeight),
            1)
          ...
          page.style.height = ( ( pageHeight + config.pdfPageHeightOffset ) *
            numberOfPages ) + 'px'
          ...
          if (config.showNotes) {
            ...
            if (notes) {
              ...
              if (notesLayout === 'separate-page') {
                ...
                notesElement.style.width = ( pageWidth - notesSpacing * 2 ) +
                  'px'
          ...
          if (config.slideNumber && /all|print/i.test(config.showSlideNumber)) {
            var slideNumberH = parseInt(slide.getAttribute('data-index-h'),
              10) + 1,
            ...
            numberElement.innerHTML = formatSlideNumber(slideNumberH, '.',
              slideNumberV)
  ...
  function createBackground (slide, container) {
    ...
    if (data.backgroundSize) element.setAttribute('data-background-size',
      data.backgroundSize)
  ...
  function transformSlides (transforms) {
    ...
    if (typeof transforms.layout ===
      'string') slidesTransform.layout = transforms.layout
    if (typeof transforms.overview ===
      'string') slidesTransform.overview = transforms.overview
      ...
      for (var i = 0, len = slides.length; i < len; i++) {
        ...
        if (config.center || slide.classList.contains('center')) {
          ...
          if (slide.classList.contains('stack')) {
            ...
            slide.style.top = Math.max(( size.height - slide.scrollHeight ) / 2,
              0) + 'px'
          }
        }
        else {
  ...
  function layoutOverview () {
    ...
    toArray(dom.background.childNodes).forEach(function (hbackground, h) {
      transformElement(hbackground, 'translate3d(' +
        ( h * overviewSlideWidth ) + 'px, 0, 0)')
  ...
  function slide (h, v, f, o) {
    ...
    indexh = updateSlides(HORIZONTAL_SLIDES_SELECTOR,
      h === undefined ? indexh : h)
    indexv = updateSlides(VERTICAL_SLIDES_SELECTOR,
      ...
      for (var x = 0; x < horizontalSlidesLength; x++) {
        ...
        if (config.loop) {
          distanceX = Math.abs(( ( indexh || 0 ) - x ) %
            ( horizontalSlidesLength - viewDistance )) || 0
        }
  ...
  function updateProgress () {
    ...
    if (config.progress && dom.progressbar) {
      ...
      dom.progressbar.style.width = getProgress() * dom.wrapper.offsetWidth +
        'px'
  ...
  function updateSlideNumber () {
    ...
    if (config.slideNumber && dom.slideNumber) {
      ...
      dom.slideNumber.innerHTML = formatSlideNumber(value[0], value[1],
        value[2])
    }
  ...
  function updateParallax () {
    ...
    if (config.parallaxBackgroundImage) {
      ...
      if (typeof config.parallaxBackgroundVertical === 'number') {
        ...
        verticalOffsetMultiplier = ( backgroundHeight - slideHeight ) /
          ( verticalSlideCount - 1 )
      }

      verticalOffset = verticalSlideCount > 0 ? verticalOffsetMultiplier *
        indexv : 0

      dom.background.style.backgroundPosition = horizontalOffset + 'px ' +
        -verticalOffset + 'px'
  ...
  function getProgress () {
    ...
    if (currentSlide) {
      ...
      if (allFragments.length > 0) {
        ...
        pastCount += ( visibleFragments.length / allFragments.length ) *
          fragmentWeight
      }
  ...
  function getSlideBackground (x, y) {
    ...
    var verticalBackgrounds = horizontalBackground &&
      horizontalBackground.querySelectorAll('.slide-background')

    if (verticalBackgrounds && verticalBackgrounds.length &&
      typeof y === 'number') {
      ...
      if (fragments.length) {
        ...
        if (typeof index !== 'number') {
          ...
          if (lastVisibleFragment) {
            index = parseInt(lastVisibleFragment.getAttribute(
              'data-fragment-index') || 0, 10)
          }
          else {
            index = -1
          }
        ...
        toArray(fragments).forEach(function (element, i) {
          ...
          // Visible fragments
          if (i <= index) {
            if (!element.classList.contains('visible')) fragmentsShown.push(
              element)
            element.classList.add('visible')
            element.classList.remove('current-fragment')
          ...
          // Hidden fragments
            ...
            if (element.classList.contains('visible')) fragmentsHidden.push(
              element)
  ...
  function cueAutoSlide () {
    ...
    if (currentSlide) {
      ...
      if (autoSlide && !autoSlidePaused && !isPaused() && !isOverview() &&
        ( !Reveal.isLastSlide() || availableFragments().next || config.loop ===
          true )) {
  ...
  function navigatePrev () {
    ...
    if (previousFragment() === false) {
      if (availableRoutes().up) {
        ...
        if (previousSlide) {
          var v = ( previousSlide.querySelectorAll('section').length - 1 ) ||
            undefined
          var h = indexh - 1
          slide(h, v)
        }
  ...
  function onProgressClicked (event) {
    ...
    var slidesTotal = toArray(
      dom.wrapper.querySelectorAll(HORIZONTAL_SLIDES_SELECTOR)).length
    var slideIndex = Math.floor(( event.clientX / dom.wrapper.offsetWidth ) *
      slidesTotal)
  ...
  Reveal = {
    ...
    removeEventListener: function (type, listener, useCapture) {
      if ('addEventListener' in window) {
        ( dom.wrapper ||
          document.querySelector('.reveal') ).removeEventListener(type,
          listener, useCapture)
      }
    },
